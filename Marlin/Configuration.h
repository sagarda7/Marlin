 ...
 */
#define DISTINCT_E_FACTORS //enabled to allow different E steps/mm for each extruder
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 8.888 , 8.888 } //later change this according to small servo 28byj-48 5.689 
